...
public class CustomRecursiveAssert<SELF extends CustomRecursiveAssert<SELF>> extends AbstractAssert<SELF, Object> {
    ...
    public CustomRecursiveAssert(Object actual, RecursiveComparisonConfiguration recursiveComparisonConfiguration) {
        super(actual, CustomRecursiveAssert.class);
    ...
    //        this.recursiveComparisonConfiguration = super.getRecursiveComparisonConfiguration();
    //        this.recursiveComparisonDifferenceCalculator = new RecursiveComparisonDifferenceCalculator();
    //    }

    //    public CustomRecursiveAssert<?> usingRecursiveComparison() {
    //        // overridden for javadoc
    //        return new CustomRecursiveAssert<>(actual, recursiveComparisonConfiguration).withAssertionState(myself);
    //    }

    //
    public SELF customTextIsEqualTo(Object expected) {
...
//    }
     ...
     * if we ignore the {"bar"} field with {@link org.assertj.core.api.RecursiveComparisonAssert#ignoringFields(String...)} the comparison will only report differences on {@code {foo, baz}} fields..
     * <p>
     * Usage example:
     * <pre><code class='java'> class Person {
     *   String name;
